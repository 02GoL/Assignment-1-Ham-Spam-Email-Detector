...
public class TestFile {
    ...
    @JsonProperty("guessClass")
    private String guessClass;

    public TestFile(String filename, double spamProbability, String guessClass, String actualClass) {
     ...
     */
    public String getGuessClass(){return this.guessClass;}
